...
|--------|-------------|---------|
| [loyalty-specialist](./plugins/loyalty-specialist/) | Jeri - Generate professional PDF loyalty program performance reports by querying Metabase and analyzing program data | 202602.18.2 |
...
| [loyalty-template-creator](./plugins/loyalty-template-creator/) | Jeri - Create CDN loyalty page templates for Shopify theme extensions by replicating a reference website's style | 202603.09.0 |
