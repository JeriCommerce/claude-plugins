...
**Labels** — Suggest appropriate labels based on the area affected. Use `Linear:list_issue_labels` to see available labels for the Development team. Common categories:

- Area: `wallet`, `web-app`, `api`, `dashboard`, `integrations`, `push-notifications`
- Type: `bug`, `customer-report`
